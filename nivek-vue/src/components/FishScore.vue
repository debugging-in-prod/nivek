...
let displayFishScore = ref(false)
...
<template>
  <h2>Fishing</h2>
  <button class="btn btn-primary" @click="displayFishScore = !displayFishScore">
    <span>Click here to {{ displayFishScore ? 'hide' : 'show'}}</span>
  </button>
  <div :class="[{ hidden: !displayFishScore }]">
    <p>As Chatter: </p>
