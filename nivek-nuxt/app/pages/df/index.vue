...
async function loadSnapshot() {
    try {
        ...
        error.value = (err as { message?: string })?.message ?? 'unknown error'
    }
}
...
<template>
    <div class="df-page">
        <header>
            <div class="header-row">
                ...
                <div class="nav-group">
                    ...
                    <NuxtLink to="/df/help" class="nav-btn">Help</NuxtLink>
                </div>
            </div>
        ...
        <p class="note">
            ...
            new data every 15s. Citizen roster is on the <NuxtLink to="/df/citizens">Citizens</NuxtLink> page.
        </p>
